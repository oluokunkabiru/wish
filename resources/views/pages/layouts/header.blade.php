<header id="header">
    ...
    <div class="container">
      <div class="row pad-logo logo-wrapper">
        <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12 t-logo"><a href="index-2.html"><img src="{{ asset('assets/images/header/logo-2.png') }}" alt="logo" class="img-responsive"></a></div>
