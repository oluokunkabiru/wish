...
<div id="minimal-bootstrap-carousel" data-ride="carousel" class="carousel slide carousel-fade shop-slider full_width ver_new_1_slider">
    ...
    <div role="listbox" class="carousel-inner">
      <div style="background-image: url({{ asset('assets/images/slider/homepage/5.jpg') }});" class="item active">
      ...
      <div style="background-image: url({{ asset('assets/images/slider/homepage/1.jpg') }});" class="item">
        <div class="carousel-caption">
          <div class="thm-container">
            <div class="box valign-top">
              <div class="content text-left pull-right">
      ...
      <div style="background-image: url({{ asset('assets/images/slider/homepage/2.jpg') }});" class="item">
        <div class="carousel-caption">
          <div class="thm-container">
            <div class="box valign-top">
              <div class="content text-left pull-right">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-4 service-info">
          <div class="item"><a href="agricultural.html" class="post-image view image_hover">			<img src="{{ asset('assets/images/services/ser-img1.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a><a href="agricultural.html">
        ...
        <div class="col-sm-4 service-info">
          <div class="item"><a href="agricultural.html" class="post-image view image_hover"><img src="{{ asset('assets/images/services/ser-img2.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a><a href="agricultural.html">
        ...
        <div class="col-sm-4 service-info">
          <div class="item"><a href="oil.html" class="post-image view image_hover">		<img src="{{ asset('assets/images/services/ser-img3.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a><a href="oil.html">
      ...
      <div class="row">
        <div class="col-sm-4 service-info">
          <div class="item"><a href="power.html" class="post-image view image_hover"><img src="{{ asset('assets/images/services/ser-img4.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a><a href="power.html">
        ...
        <div class="col-sm-4 service-info">
          <div class="item"><a href="chemical.html" class="post-image view image_hover"><img src="{{ asset('assets/images/services/ser-img5.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a><a href="chemical.html">
        ...
        <div class="col-sm-4 service-info">
          <div class="item"><a href="meterial.html" class="post-image view image_hover"><img src="{{ asset('assets/images/services/ser-img6.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a><a href="meterial.html">
  ...
  <section class="container ind-common-pad2 clearfix">
    <div class="quality-wrapper text-center">
      ...
      <div class="vision-wrapper text-center">
        <ul>
          <li><a id="vision" href="javascript:void(0)"><img src="{{ asset('assets/images/services/ser-icon4.png') }}" alt="">
              <p>Vision</p></a></li>
          <li><a id="values" href="javascript:void(0)"><img src="{{ asset('assets/images/services/ser-icon5.png') }}" alt="">
              <p>Values</p></a></li>
          <li><a id="mission" href="javascript:void(0)"><img src="{{ asset('assets/images/services/ser-icon6.png') }}" alt="">
              <p>Mission</p></a></li>
        </ul>
      </div>
    </div>
  ...
  <section class="fluid-service-area-home">
    <div class="work-image-ser"><img src="{{ asset('assets/images/services/ser-img-left.jpg') }}" alt=""></div>
    <div class="service-promo">
      <div class="service-t-content">
        <div class="test-quote-sec"><img src="{{ asset('assets/images/testimonial/quote-n.png') }}" alt=""></div>
        <div class="testimonial-t-sec">
          <div class="testimonialn-slider">
            <div class="item">
              <div class="name-content clearfix">
                <div class="tst-img"><img src="{{ asset('assets/images/testimonial/test-img2.png') }}" alt=""></div>
              ...
              <div class="sign text-right"><img src="{{ asset('assets/images/testimonial/sign-n.png') }}" alt=""></div>
            </div>
            <div class="item">
              <div class="name-content clearfix">
                <div class="tst-img"><img src="{{ asset('assets/images/testimonial/test-img2.png') }}" alt=""></div>
  ...
  <div class="container clearfix sectpad-sec">
    ...
    <div class="row event-pad">
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="news-evn-img"><a href="news.html" class="image_hover"><img src="{{ asset('assets/images/event/1.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="news-evn-img"><a href="news.html" class="image_hover"><img src="{{ asset('assets/images/event/2.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a>
          <div class="event-date">
            <h3>05 <small>Aug</small></h3>
          </div>
        </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="news-evn-img"><a href="news.html" class="image_hover"><img src="{{ asset('assets/images/event/3.jpg') }}" alt="" class="img-responsive zoom_img_effect"></a>
          <div class="event-date">
            <h3>05 <small>Aug</small></h3>
          </div>
        </div>
  ...
  <div class="container clearfix ind-common-pad">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 our-t-client">
        ...
        <ul>
          <li><img src="{{ asset('assets/images/clients/7.jpg') }}" alt="" class="img-responsive"></li>
          <li><img src="{{ asset('assets/images/clients/8.jpg') }}" alt="" class="img-responsive"></li>
          <li><img src="{{ asset('assets/images/clients/9.jpg') }}" alt="" class="img-responsive"></li>
        </ul>
        <ul>
          <li><img src="{{ asset('assets/images/clients/10.jpg') }}" alt="" class="img-responsive"></li>
          <li><img src="{{ asset('assets/images/clients/11.jpg') }}" alt="" class="img-responsive"></li>
          <li><img src="{{ asset('assets/images/clients/12.jpg') }}" alt="" class="img-responsive"></li>
        </ul>
      </div>
