                                            ...
                                            <td>
                                                <div class="row">
                                                    @if ($theme->active == 'disabled')
                                                        <a href="#activateTheme" data-toggle="modal"
                                                            themeId="{{ $theme->id }}"
                                                            activateurl="{{ route('activateTheme') }}"
                                                            activateTheme={{ ucwords($theme->name) }}
                                                            class="badge badge-pill badge-success m-1"><span
                                                                class="fa fa-key p-1 text-white"></span></a>

                                                    @else
                                                        <a href="#deactivateTheme"
                                                            deactivateurl="{{ route('themeDisable', $theme->id) }}"
                                                            data-toggle="modal"
                                                            deactivateTheme={{ ucwords($theme->name) }}
                                                            class="badge badge-pill badge-warning m-1"><span
                                                                class="fa fa fa-lock p-1 text-white"></span></a>
                                                    @endif
                                                    <a href="#editTheme" data-toggle="modal"
                                                        categoryValue="{{ $theme->category_id }}"
                                                        categoryName="{{ ucwords($theme->category->name) }}"
                                                        paymentValue="{{ $theme->status }}"
                                                        paymentName="{{ ucwords($theme->status) }}"
                                                        nameValue="{{ old('name', $theme->name) }}"
                                                        priceValue="{{ old('price', $theme->price) }}"
                                                        descriptionValue="{{ old('description', $theme->description) }}"
                                                        editUrl="{{ route('theme.update', $theme->id) }}"
                                                        class="badge badge-pill badge-warning m-1"><span
                                                            class="fa fa-edit p-1 text-white"></span></a>
                                                    <a href="#deleteTheme" data-toggle="modal"
                                                        delurl="{{ route('theme.destroy', $theme->id) }}"
                                                        delTheme={{ ucwords($theme->name) }}
